...
function serveLandingPage(req: express.Request, res: express.Response) {
  ...
  const providers: Array<{
    ...
    },
    {
      ...
      tags: ["Movies", "TV Series", "TMDB", "Direct Links"],
      desc: "Fast streaming with direct TMDB integration and redirect resolution.",
    },
    {
      key: "moviebox",
      name: "MovieBox",
...
<meta name="description" content="INFINITE STREAMS — 9 providers, one addon. AnimeSalt, RareAnime, AnimeDekho, NetMirror, DooFlix, MovieBox, HindMoviez, HDHub4U, ZinkMovies. Install in one click."/>
...
<section class="hero">
  ...
  <div class="container">
    ...
    <div class="hero-pill">
      ...
      Live · 9 Providers · No P2P · No Signup
    </div>
    ...
    <!-- STATS -->
    <div class="stats-row">
      <div class="stat"><div class="stat-num">9</div><div class="stat-lbl">Providers</div></div>
  ...
  <div class="container">
    ...
    <div class="steps-grid">
      ...
      <div class="step-card">
        ...
        <p class="step-body">Search any movie, series or anime. INFINITE STREAMS queries all 9 providers in parallel and shows every available stream.</p>
...
<footer>
  <div class="footer-inner">
    ...
    <p class="footer-desc">9 providers, zero compromise. Movies, series &amp; anime from every corner of the web. Free forever.</p>
    ...
    <div class="footer-status">
      ...
      By @Master_si · v${manifest.version} · 9 Providers
    </div>
  </div>
</footer>
...
<div class="sticky-bar" id="sticky-bar">
  <div class="sticky-bar-left">
    ...
    <div>
      ...
      <div class="sticky-bar-sub">9 providers, one addon</div>
    </div>
  </div>
